export const Footer = () => {
    return (
        <footer className="bg-[#ff7c08] text-white py-16 px-6">
            <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                <div className="col-span-1 lg:col-span-2">
                    <div className="flex items-center gap-2 mb-4">
                        <img src="/logo-icon.png" alt="MCosta Ecofood" className="h-14 w-auto object-contain drop-shadow-md brightness-200 contrast-200" />
                    </div>
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        <a href="https://www.facebook.com/ecofoodpack" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition-colors">
                        ...
                        <a href="https://www.instagram.com/mcostaecofoodpack/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition-colors">
                        ...
                        <a href="https://www.youtube.com/channel/UCyMh31y0i5z8k3hO1eQ1kUQ" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center hover:bg-white/40 transition-colors">
                ...
                <div>
                    <h4 className="font-body font-bold text-lg mb-4 text-white">Links Rápidos</h4>
