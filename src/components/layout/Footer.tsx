            ...
            <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                <div className="col-span-1 lg:col-span-2">
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        ...
                        <a href="https://www.instagram.com/ecofoodpack/" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-accent-primary transition-colors">
